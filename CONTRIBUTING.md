# Contributing to the Top.gg Go SDK
Thank you for considering contributing to the Top.gg Go SDK!
We accept contributions of all shapes and sizes, from bug fixes and typo corrections to new features and enhancements.

## Prerequisites
- Go 1.19 or later (downloadable from [the official Go website](https://go.dev/dl/))
...
## Lefthook Setup
This project uses [Lefthook](https://lefthook.dev/) for development to run pre-commit hooks for linting and formatting. \
...
PRs will likely _not_ be merged if they do not follow these conventions.
...
- Add links to [Top.gg's API documentation](https://docs.top.gg/api) when creating new structs or modifying existing ones.
